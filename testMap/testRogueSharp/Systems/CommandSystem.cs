...
namespace testRogueSharp.Systems{
    ...
    public class CommandSystem{
        ...
        public void Attack(Actor attacker, Actor defender){
            ...
            if(!string.IsNullOrWhiteSpace(defenseMessage.ToString())){ // S'il y a eu une défense
        ...
        public void ActivateMonsters(){
            ...
            if(scheduleable is Player){ // Si c'est au tour du joueur, on met le boolean à true puis on le réinsert dans le scheduling system vu qu'il y est supprimé dans le Get
                IsPlayerTurn = true;
