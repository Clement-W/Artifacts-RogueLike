...
namespace testRogueSharp.Core
{
    ...
    // contient les raw colors
    {
        // Permet de donner un nom à toutes les couleurs qui seront utilisées
        // http://paletton.com/#uid=73d0u0k5qgb2NnT41jT74c8bJ8X -> pour faire une palette
